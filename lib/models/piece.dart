...
class Piece {
  ...
  const Piece({required this.id, required this.owner, required this.polarity});

  Piece copyWith({Polarity? polarity}) =>
      Piece(id: id, owner: owner, polarity: polarity ?? this.polarity);

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Piece && other.id == id && other.owner == owner && other.polarity == polarity);
